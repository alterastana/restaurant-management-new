    ...
    <div class="bg-white p-8 rounded-2xl shadow-lg">
        <div class="space-y-6">
            <div class="flex items-start">
                <div class="flex-shrink-0 w-8 text-brand-primary">
        ...
        <div class="mt-8 border-t pt-6 flex justify-end">
             <a href="{{ route('Dashboard.restoran.edit', $restoran) }}" class="px-6 py-2 text-sm font-medium text-white btn-secondary rounded-lg shadow-md focus-brand">
                Edit Restoran Ini
            </a>
        </div>
        @endif
