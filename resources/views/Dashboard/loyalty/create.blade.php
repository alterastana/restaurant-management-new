...
@section('title', 'Tambah Data Loyalty')
@section('content')
    <h1 class="text-3xl font-bold text-gray-800 mb-4">Tambah Data Loyalty</h1>
        ...
        <form action="{{ route('Dashboard.loyalty.store') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" name="points" id="points" value="0" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm" required>
                </div>
                <div>
                    <label for="membership_level" class="block font-medium text-gray-700">Level Membership</label>
                    <input type="text" name="membership_level" id="membership_level" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm" placeholder="e.g., Silver, Gold, Platinum" required>
                </div>
            </div>
